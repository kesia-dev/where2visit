  ...
  const steps = [
    {
      ...
      content2: '<br><span style="color: #000000cc; font-size: 17px; ;font-weight: 400; font-family: inter; letter-spacing: -0.41px; line-height: 22px">Restaurant / Activities / Hotels</span>',
        ...
        <DialogContent>
          <CardContent className="customCardContent" style={{ padding: '0px' }}>
            ...
            <MobileStepper
              ...
              position="static"
              activeStep={step}
              sx={{ flexGrow: 1, alignItems: 'center', justifyContent: 'center', marginBottom: '30px'}}
              dotactivestyle={{ backgroundColor: 'black' }}
              dotstyle={{ backgroundColor: 'grey' }}
            />

            {/* Step Image and Content */}
            <Box display="flex" flexDirection="column" alignItems="center" sx={{marginTop: '2px'}}>
            ...
            {step < 4 && (
              <div style={{ display: 'flex', justifyContent: 'center', marginTop: '35px' }}>
                <Button variant="contained" onClick={handleNext} style={{ borderRadius: '100px', width: '100px', height: '53px', background: '#3492C7' }}>
                  Next
                </Button>
              </div>
            ...
            {step === 0 && (
              <Typography
                variant="body2"
                sx={{ textAlign: 'center', marginTop: 2, cursor: 'pointer', color: '#3492C7', fontWeight: 700 }}
                onClick={handleSkip}
                fontSize={'15px'}
                fontFamily={'Inter'}
              >
            ...
            {step === 4 && (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', overflowY: '0' }}>
                ...
                {/* Ready to start text */}
                <Box style={{ alignItems: 'center', width: '100%', marginBottom: '30px', marginTop: '80px' }}>
                  <Typography
                    color="text.secondary"
                    align="center"
                    fontFamily="Inter"
                ...
                <Button variant="contained" color="primary" onClick={handleCreatePlan} sx={{ borderRadius: '100px', textTransform: 'none', width: '200px', height: '50.34px', marginTop: '20px', background: '#3492C7' }}>
                ...
                <Typography
                  variant="body2"
                  sx={{ textAlign: 'center', marginTop: 1, cursor: 'pointer', color: '#3492C7', fontWeight: 700 }}
                  onClick={handleSkip}
                  fontSize={'15px'}
                  fontFamily={'Inter'}
                  color="primary"
